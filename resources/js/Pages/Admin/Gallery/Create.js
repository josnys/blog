                         ...
                         <div className="md:col-span-1">
                              <div className="px-4 sm:px-0">
                                   ...
                                   <p className="mt-1 text-sm text-gray-600">
                                        Use this form to create a new gallery that can be used in any type of publication.
                                   </p>
                                   <h4 className="mt-4 text-md text-gray-600">Selected Media for Gallery <span className="font-medium">{data.identifier}</span></h4>
                                   {(data.media.length > 0) && (<div className="col-span-12 mt-4">
                                        <div className="w-full grid grid-cols-3 gap-3">
                                             {data.media.map((img, i) => {
                                                  return <img className="aspect-w-1 aspect-h-1" onClick={e=>handleRemove(e,i)} key={i} src={img.url} />
                                             })}
                                        </div>
                                   </div>)}
                              </div>
...
Create.layout = page => <Layout children={page} header={'Create Gallery'} />;
