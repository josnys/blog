...
const Create = () => {
     ...
     const { data, setData, post, processing, errors } = useForm({
          name: info.lang.name || '',
          code: info.lang.code || '',
          current_code: info.lang.code || '',
          flag: null,
          selectedFlag: null,
          status: info.lang.status || true,
     });
                         ...
                         <div className="md:col-span-1">
                              <div className="px-4 sm:px-0">
                                   ...
                                   <p className="mt-1 text-sm text-gray-600">
                                        Edit a language to enable different translation in the website.
                                   </p>
                                   <p className="mt-1 text-md text-gray-800 text-center">Actual Flag</p>
                                   {info.lang.flag && (<img src={`${info.lang.flag}`} className="mx-auto h-20 w-20" />)}
                              </div>
                         </div>
                         <DataCard>
...
Create.layout = page => <Layout children={page} header={'Edit Language'} />;
